...
// --- Interactive Text (Instant Reset Logic) ---
...
// --- 3D Background (Dull Ambient / Bright Interaction) ---
    ...
    useEffect(() => {
        ...
        class Node {
            ...
            draw(ctx, mouseX, mouseY) {
                ...
                if (dist < lightRadius) {
                    // Flashlight Effect (Bright Purple)
        ...
        const animate = () => {
            ...
            // 2. Very subtle ambient gradient (almost black)
...
const Stat = ({ value, label }) => (
    <div className="flex flex-col items-start p-4 border-l border-white/10 hover:border-purple-500/50 transition-colors group">
    <span className="text-3xl md:text-4xl font-bold text-white font-sans tracking-tight group-hover:text-purple-300 transition-colors whitespace-nowrap">
      {value}
    </span>
